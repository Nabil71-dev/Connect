...
function PostCard({ props }) {
    ...
    const { id,usermail, username, date, post_topic, no_of_vacancy, post_header, post, post_pic } = props
        ...
        <>
            <div className="cardContainer contentBg container">
                <div className="d-flex justify-content-between mt-3 mb-2">
                    ...
                    <div>
                        {
                            (currentuser === usermail) && <Threedot props={id}/>
                        }
                    </div>
                </div>
                <div className="d-flex">
                ...
                <div>
                    ...
                    <Article text={post} />
                    {
                        post_pic && <img src={post_pic} alt="Post_image-if-uploaded" className={`${style.postImage}`} />
                    }
                </div>
